...
public class Coches extends Garaxe{
  ...
  public void factura(){
     ...
     if (horas<3){ //se e menor a tres aplicaselle a tarifa de 0,50 a hora,amosando pago e devolución
     ...
     }   else if(horas>3)    //se o coche está mais de 3 horas aplicaselle a segunda tarifa e amosase o pago e a devolución     
